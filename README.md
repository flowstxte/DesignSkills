# DesignSkills — Inspired Design System
...
<p align="center">
  <img src="https://raw.githubusercontent.com/flowstxte/DesignSkills/refs/heads/main/ss.png" width=60%/>
</p>
...
- **Instant Brand Identity:** Attach a single markdown file to make your AI generate interfaces that feel like Nike, Spotify, or other top-tier brands.
- **Custom Aesthetics:** specialized styles for specific vibes, including moody neo-noir, high-contrast layouts, and atmospheric cinematic UI.
- **Eliminate CSS Hallucinations:** Strict guidelines for spacing, typography, motion, and color palettes keep the AI focused and consistent.
- **Agent-Ready Prompts:** Built-in cheat sheets inside every file to help you prompt the AI effectively for specific components.

---

## How It Works

1. **Choose a Style:** Browse the repository and pick a `.md` file that matches your desired visual theme.
2. **Attach to Prompt:** Upload or paste the contents of the chosen `DESIGN.md` file into your conversation with your AI agent.
3. **Prompt the Agent:** Ask the AI to build your component or page (e.g., _"Build a video capture dashboard layout using the attached design system."_).
4. **Deploy:** Take the cohesive, beautifully styled code generated by the AI and drop it right into your project.
...
These are not official design systems from the companies mentioned. They are starting points based on design patterns that can be seen publicly. All trademarks, brand names, and design elements belong to their respective owners. These DESIGN.md files are meant to document these patterns for learning and development purposes.
